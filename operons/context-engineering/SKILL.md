...
description: >
  This skill should be used when dealing with context problems, context rot,
  sessions going sideways, forgetting instructions, token optimization,
  context hygiene, or when outputs become contradictory or inconsistent.
  MESO operon (Gastrozooid — Information Ingestion).
---
