...
name: recovery
description: >
  This skill should be used when something goes wrong, debugging errors,
  recovering from failures, handling context rot, resolving merge conflicts,
  recovering from permission failures, or deciding when to give up on prompting.
  MESO operon (Vibraculum — Debris Clearing).
---
